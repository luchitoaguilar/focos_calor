        ...
        return DataTables::of($focos)
            ...
            ->addColumn('nivel', function ($focos) {
                if ($focos->nivel == 'Primera Generación') {
                    return '<div class="d-flex justify-content-center"><button type="button" class="btn bg-light btn-flat margin disabled">Primera Generación</button></div>';
                } elseif (($focos->nivel == 'Segunda Generación')) {
                    return '<div class="d-flex justify-content-center"><button type="button" class="btn bg-success btn-flat margin disabled" style="text-align:center;display:block">Segunda Generación</button></div>';
                } elseif (($focos->nivel == 'Tercera Generación')) {
                    return '<div class="d-flex justify-content-center"><button type="button" class="btn bg-primary btn-flat margin disabled" style="text-align:center;display:block">Tercera Generación</button></div>';
                } elseif (($focos->nivel == 'Cuarta Generación')) {
                    return '<div class="d-flex justify-content-center"><button type="button" class="btn bg-warning btn-flat margin disabled" style="text-align:center;display:block">Cuarta Generación</button></div>';
                } elseif (($focos->nivel == 'Quinta Generación')) {
                    return '<div class="d-flex justify-content-center"><button type="button" class="btn bg-orange btn-flat margin disabled" style="text-align:center;display:block">Quinta Generación</button></div>';
