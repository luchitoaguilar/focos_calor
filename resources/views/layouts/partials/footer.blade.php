<footer class="text-center text-lg-start text-white  bg-dark" style="background-color: #1c2331; width:100%">
    <!-- Section: Social media -->
    <section class="d-flex justify-content-between p-4" style="background-color: #888a8a">
        <!-- Left -->
        ...
        <div class="container text-center text-md-start mt-5">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                    <!-- Content -->
                    <h6 class="text-uppercase fw-bold">ECEME</h6>
                    <hr class="mb-4 mt-0 d-inline-block mx-auto"
                        style="width: 60px; background-color: #ffffff; height: 2px" />
                    <p>
                        <img src="{{ asset('ecem-logo.jpeg') }}" width="100" height="100"
                ...
                <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                    <!-- Links -->
                    <h6 class="text-uppercase fw-bold">APLICACIONES</h6>
                    <hr class="mb-4 mt-0 d-inline-block mx-auto"
                        style="width: 60px; background-color: #ffffff; height: 2px" />
                    <p>
                    ...
                    <p>
                        <a href="https://apppage.net/preview/at.xylem.mapin" target="_blank"
                            class="text-white">MAPinr</a>
                    </p>
                </div>
                <!-- Grid column -->
                ...
                <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                    <!-- Links -->
                    <h6 class="text-uppercase fw-bold">SISTEMAS RELACIONADOS</h6>
                    <hr class="mb-4 mt-0 d-inline-block mx-auto"
                        style="width: 60px; background-color: #ffffff; height: 2px" />
                    <p>
                        <a href="https://simb.siarh.gob.bo/simb/map_heat_source" target="_blank"
                            class="text-white">SIMB</a>
                    </p>
                    <p>
                        <a href="https://www.windy.com" target="_blank" class="text-white">WINDY</a>
                    </p>
                    <p>
                        <a href="https://reliefweb.int/report/bolivia-plurinational-state/satif-sistema-de-alerta-temprana-de-incendios-forestales-30-de-7"
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                    <!-- Links -->
                    <h6 class="text-uppercase fw-bold">My. Inf. Jose Lopez Flores</h6>
                    <hr class="mb-4 mt-0 d-inline-block mx-auto"
                        style="width: 60px; background-color: #ffffff; height: 2px" />
                    <p><img src="{{ asset('lopez.jpeg') }}" width="100" height="100"
                            class="d-inline-block align-top" alt="">
                    </p>
                </div>
                <!-- Grid column -->
