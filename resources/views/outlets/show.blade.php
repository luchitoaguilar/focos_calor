                    ...
                    <table class="table table-sm">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-outline-info btn-lg btn-block" data-toggle="modal"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <embed src="{{ asset($outlet->archivo) }}" type="application/pdf" width="100%" height="400px" />
                        </td>
                    </div>
        ...
        <div class="modal fade" id="fotoModal" tabindex="-1" role="dialog" aria-labelledby="fotoModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img src="{{ asset($outlet->foto) }}" class="img-thumbnail" style="width: 80%; heigth: 50px">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                    </div>
